...
while continue_game:
    ...
    tube_coords, tube_coord1, tube_coord2, tk_tube_coords,\
                 tube_pic = tube_tool.coords_and_pic()                 
    
    maze[tube_coords] = str(tube_tool.name)
    tube_TK_coords = tk_tube_coords

    needle_tool = tool.Tool("needle")
    needle_coords, needle_coord1, needle_coord2, tk_needle_coords,\
                   needle_pic = needle_tool.coords_and_pic()                
    ...
    murdock_coords, tk_murdock_coords, murdock_pic =\
                    murdock_character.coords_and_pic()
